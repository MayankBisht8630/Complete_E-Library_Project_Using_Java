                ...
                <div class ="row">
                    <div class="col-md-6 offset-md-3">
                        <div class="card ml-1">
                            ...
                            <div class="card-body">
                                <form id="wishlist-form" action="WishlistServlet" method="post">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td> <input type="hidden" name="bookname" value ="<%= p.getpTitle()%>"><%= p.getpTitle()%></td>
                                                <td> <input type="hidden" name="authorname" value ="<%= p.getpContent()%>"><%= p.getpContent() %></td>
