                ...
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <h4>All Books</h4>
                            <a class="btn btn-primary" href="admin_all_books.jsp"> All Books </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">                   
                ...
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <h4>Delete Books</h4>
                            <a class="btn btn-primary" href="deletebook.jsp"> Delete </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <h4>Add Admin</h4>
                            <a class="btn btn-primary" href="add_admin.jsp"> Add Admin </a>
                        </div>
                    </div>
                </div> 
            </div>
