            ...
            <div class="container">
                <div class="col-md-6 offset-md-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="reg-form1" action ="RegisterAdminServlet" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail">Admin Email address</label>
                                    <input name ="user_email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Email">
                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                </div>
                                <div class="form-group">
                                    <label for="gender">Select Admin Gender</label>
                                    <br>
                                ...
                                <div class="form-group">
                                    <textarea name="about1" class="form-control" id="" cols="30" row="5" placeholder="About You !"></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <a href="admin.jsp" id="all-btn" class="btn btn-primary"> <span class=" fa fa-sign-in"></span> Admin Home </a>
                            </form>
                        </div>
                    </div>
                </div>
...
<!--        <script src="jss/myjs.js" type="text/javascript"></script>-->
        ...
        <script>
            $(document).ready(function () {
                console.log("loaded.....")
                $('#reg-form1').on('submit', function (event) {
