        ...
        <nav class="navbar navbar-expand-lg navbar-dark primary-background">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class = "navbar-nav nr-right">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="" data-toggle="modal" data-target="#cart"><i class="fa fa-book " style="font-size: 17px;"></i><span class="ml-1 cart-items">(0 Issue)</span></a>
                    </li> 
                    <li class="nav-item">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-4 mt-4">
                    ...
                    <div class="list-group">
                        ...
                        <br>
                        <br>
                        <!--                        <a href="wishlist.jsp" class="btn text-center btn-primary text-white"><span class="fa fa-heart"></span> My WishList</a>-->
